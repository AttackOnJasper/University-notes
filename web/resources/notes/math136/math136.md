...
- **Vector** n-tuple of real numbers
	- Elements in a vector is called entries, components, or coordinates
...
- Vectors within 3-d can be represented as **Direct Line Segment**

**Vector Equation** of the line L: x = a + td, where d is **direction vector**
